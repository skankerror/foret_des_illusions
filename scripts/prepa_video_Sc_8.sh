...
/usr/bin/oscsend localhost 12345 /mapmap/paint/opacity if 12 0
...
/usr/bin/oscsend localhost 12345 /mapmap/mapping/visible if 7 0
...
#/usr/bin/oscsend localhost 12345 /mapmap/paint/uri is 7 /home/ray/boulot/cueilleurs_de_brume/foret/video/Sc_1-1.mp4
